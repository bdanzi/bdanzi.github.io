...
button_1.className = currentClass_button_1 == "button primary color2 circle icon solid fa-sun" ? "button primary color2 circle icon solid fa-moon" : "button primary color2 circle icon solid fa-sun";
localStorage.setItem("stateMode",button_1.className);
button_2.className = currentClass_button_2 == "button primary color2 circle icon solid fa-sun" ? "button primary color2 circle icon solid fa-moon" : "button primary color2 circle icon solid fa-sun";
localStorage.setItem("stateMode",button_2.className);
button_3.className = currentClass_button_3 == "button primary color2 circle icon solid fa-sun" ? "button primary color2 circle icon solid fa-moon" : "button primary color2 circle icon solid fa-sun";
localStorage.setItem("stateMode",button_3.className);
button_4.className = currentClass_button_4 == "button primary color2 circle icon solid fa-sun" ? "button primary color2 circle icon solid fa-moon" : "button primary color2 circle icon solid fa-sun";
localStorage.setItem("stateMode",button_4.className);
button_5.className = currentClass_button_5 == "button primary color2 circle icon solid fa-sun" ? "button primary color2 circle icon solid fa-moon" : "button primary color2 circle icon solid fa-sun";
