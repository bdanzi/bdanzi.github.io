...
function changeImage() {
    ...
    previewImage.src = `merry-xmas-generator/images/img_${currentImageIndex}.png`;
}
...
function changeText() {
    ...
    previewText.src = `merry-xmas-generator/images/txt_${currentTextIndex}.png`;
}
...
function updateSender() {
    ...
    if(txt.trim().length > 0) {
        ...
        previewSender.innerText = 'Wishes';
    }
